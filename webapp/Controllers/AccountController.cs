    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(AccountLoginModel viewModel)
        {
            ...
            if (user != null)
            {
                ...
                bool senhaCorreta = await _manager.CheckPasswordAsync(user, viewModel.Password);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> RegisterFromFuncionario(AccountRegistrationModel viewModel)
        {
            ...
            Funcionarios funcionario = db.Funcionarios.Find(viewModel.id_funcionario);
            
            //Caso não encontre o funcionario, retornar com erro
            if (funcionario == null)
            {
                //De alguma forma mostrar que não foi encontrado o usuario
            ...
            try
            {
                ...
                //Marcar no funcionario que o usuario para ele foi criado
                funcionario.id_user = user.Id;
                funcionario.AspNetUsers = db.AspNetUsers.Find(user.Id);
